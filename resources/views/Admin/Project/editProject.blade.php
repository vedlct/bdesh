                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route('project.updateData')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                <input type="hidden" id="projectId" name="id" value="{{$project->projectId}}">
                                <label class="col-sm-2 col-form-label">Project Name</label>
                                <div class="col-sm-10">
                                    <input type="text" name="projectName" value="{{$project->pName}}" class="form-control" required placeholder="Project Name">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="projectLocation"value="{{$project->pLocation}}" class="form-control" required placeholder="Project Location">
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="pDescription" class="summernote"> {!! $project->pDescription !!}</textarea>
                                </div>
                            </div>
                            <div class="form-group row">
