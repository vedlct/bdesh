                            ...
                            <div class="col-sm-8">
                                ...
                                <div class="form-group required">
                                    ...
                                    <ul class="payment-method clearfix">
                                        <li class="active">
                                            <div class="payment-logo"><img src="{{url('public/images/payment-1.png')}}" alt=""/></div>
                                            <input type="radio" name="payment" id="payment" value="1" checked />
                                        </li>

                                        <li>
                                            <div class="payment-logo"><img src="{{url('public/images/payment-2.png')}}" alt=""/></div>
                                            <input type="radio" name="payment" value="2" />
                                        </li>

                                        <li>
                                            <div class="payment-logo"><img src="{{url('public/images/payment-3.png')}}" alt=""/></div>
